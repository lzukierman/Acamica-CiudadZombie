...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 170,400, 30,30,1),
    new Obstaculo('imagenes/valla_horizontal.png',160, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png',100, 230, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png',480, 230, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png',310,440,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',320,440,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',500, 230, 30, 30, 1),
    new Obstaculo('imagenes/bache.png',380,230,30,30,1),
    new Obstaculo('imagenes/bache.png',480,123,30,30,1),
    new Obstaculo('imagenes/bache.png',460,303,30,30,1),
    new Obstaculo('imagenes/bache.png',820,500,30,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png',420,103,15,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png',420,403,15,30,1),
    new Obstaculo('imagenes/auto_verde_abajo.png',820,110,15,30,1),
    new Obstaculo('imagenes/auto_verde_derecha.png',820,403,30,15,1),
    new Obstaculo('imagenes/auto_verde_derecha.png',490,403,30,15,1),
    new Obstaculo('imagenes/auto_verde_derecha.png',510,103,30,15,1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 300, 40, 10, 10, 1, {
      desdeX: 0,
      hastaX: 577,
      desdeY: 0,
      hastaY: 961
    ...
    new ZombieCaminante('imagenes/zombie2.png', 200, 200, 10, 10, 1, {
      desdeX: 0,
      hastaX: 577,
      desdeY: 0,
      hastaY: 961
    }),
    new ZombieCaminante('imagenes/zombie3.png', 300, 300, 10, 10, 1, {
      desdeX: 0,
      hastaX: 577,
      desdeY: 0,
      hastaY: 961
    }),
    new ZombieCaminante('imagenes/zombie4.png', 400, 400, 10, 10, 1, {
      desdeX: 0,
      hastaX: 577,
      desdeY: 0,
      hastaY: 961
